		...
		if ( get_option( 'sfcd_review_notify' ) == "no" ) {
            ...
            <div class="sfcd-review-notice notice notice-info">
                <p style="font-size: 14px;">
					<?php _e( 'Hey, are you creating blog posts with the new Gutenberg Editor?<br>If yes, you will love <a href="https://wordpress.org/plugins/ultimate-blocks/" target="_blank">Ultimate Blocks</a>. We built Ultimate Blocks plugin to help you create better blog posts with Gutenberg.', 'sfcd-coupon' ); ?>
                </p>
                <ul>
